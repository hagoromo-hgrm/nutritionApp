...
function FoodRow({ food, favorite, onSelect, onAdd, onToggleFavorite, onEdit, onDelete }: { food: Food; favorite: boolean; onSelect?: (food: Food) => void; onAdd?: (food: Food) => void; onToggleFavorite: (food: Food) => void; onEdit?: (food: Food) => void; onDelete?: (food: Food) => void }) {
